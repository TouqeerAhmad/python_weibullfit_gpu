...
# The follwoing fit function is written by Akshay (akshay.raj.dhamija@gmail.com) to make the weibull fit possible for 
# multiple instances at parallel. 
...
def test_rndweibull():
    ...
    ax.set_zlabel('RMS Difference')
    plt.title('Root Mean Square Difference between true\n and estimated Weibull distribution parameter.')
    plt.show()
